...
import WordAssignmentStatementAnswerDetails from '@/models/statement/questions/WordAssignmentStatementAnswerDetails';
import WordAssignmentStatementQuestionDetails from '@/models/statement/questions/WordAssignmentStatementQuestionDetails';
...
export enum QuestionTypes {
  ...
  WordAssignment = 'word_assignment',
}
...
export abstract class QuestionFactory {
  static getFactory(type: string): QuestionFactory {
    switch (type) {
      ...
      case QuestionTypes.WordAssignment:
              return new WordAssignmentQuestionFactory();
      default:
...
class WordAssignmentQuestionFactory extends QuestionFactory {
  createEmptyQuestionDetails(): QuestionDetails {
    return new WordAssignmentQuestionDetails();
  }
  createQuestionDetails(details: any): QuestionDetails {
    return new WordAssignmentQuestionDetails(details);
  }
  createAnswerDetails(details: any): AnswerDetails {
    return new WordAssignmentAnswerDetails(details);
  }
  createStatementQuestionDetails(details: any): StatementQuestionDetails {
    return new WordAssignmentStatementQuestionDetails(details);
  }
  createStatementAnswerDetails(details: any): StatementAnswerDetails {
    return new WordAssignmentStatementAnswerDetails(details);
  }
  createStatementCorrectAnswerDetails(
    details: any
  ): StatementCorrectAnswerDetails {
    return new WordAssignmentStatementCorrectAnswerDetails(details);
  }
}