...
class SpockTest extends Specification {
    ...
    public static final String WORD_1 = "Word 1"
    public static final String WORD_2 = "Word 2"
    public static final String WORD_3 = "Word 3"

    public static final String PHRASE_1 = "Phrase 1"
    public static final String PHRASE_2 = "Phrase 2"
    public static final String PHRASE_3 = "Phrase 3"
