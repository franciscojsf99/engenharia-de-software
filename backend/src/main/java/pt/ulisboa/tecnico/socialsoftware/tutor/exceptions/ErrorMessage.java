...
public enum ErrorMessage {
    ...
    EMPTY_WORD("Phrases need to have 1 correct word"),
    EMPTY_PHRASE_CONTENT("Phrases need to have content"),
    AT_LEAST_ONE_PHRASE_NEEDED("Word assignment questions need to have at least one phrase."),
    PHRASE_NOT_FOUND("Phrase not found with id %d"),
